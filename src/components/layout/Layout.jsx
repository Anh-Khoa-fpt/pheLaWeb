...
const styles = StyleSheet.create({
  layout: {
    flex: 1,
    backgroundColor: '#031b11',
  },
  toolbar: {
    marginHorizontal: 16,
    marginTop: 8,
    marginBottom: 12,
    backgroundColor: 'rgba(232, 255, 237, 0.95)',
    borderRadius: 18,
    ...
    elevation: 8,
    borderWidth: 1,
    borderColor: 'rgba(14, 65, 37, 0.15)',
  },
  toolbarContent: {
    flexDirection: 'row',
  ...
  backButton: {
    backgroundColor: 'rgba(16, 58, 32, 0.12)',
    borderRadius: 14,
    paddingHorizontal: 16,
    paddingVertical: 8,
    shadowColor: '#052110',
  ...
  floatingBackButtonInner: {
    ...
    height: 48,
    borderRadius: 24,
    backgroundColor: 'rgba(233, 255, 240, 0.9)',
    ...
    elevation: 8,
    borderWidth: 1,
    borderColor: 'rgba(76, 175, 116, 0.4)',
  },
